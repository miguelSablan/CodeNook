...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen items-center justify-center p-24 overflow-auto">
      <Navbar />
      <div className="w-full max-w-screen-xl px-2.5 md:px-20 pb-28 pt-28 flex flex-col items-center justify-center text-center sm:pt-40 ">
        ...
        <div className="mt-6 flex items-center gap-8">
          <Link
            className="inline-flex items-center justify-center rounded-full text-sm font-medium border border-black bg-black px-8 h-11 text-white transition-all hover:opacity-75"
            href="/signup"
          >
            Get started
            <svg
