...
const Home = () => {
  ...
  return (
    <div className="h-screen flex md:flex-row overflow-hidden">
      <Sidebar />
      <div className="bg-[#242323] flex justify-center items-start flex-1 p-4 pt-20 md:p-7 min-h-screen overflow-y-auto">
        <div className="w-full max-w-2xl mt-10">
          <div className="p-4 mb-4 bg-[#1d1d1d] rounded-lg">
            <div className="flex">
              <Avatar />
              <textarea
                placeholder="What's on your mind?"
                className="bg-transparent px-3 py-2 rounded-md w-full text-white focus:outline-none resize-none"
                rows={2}
              />
            </div>
